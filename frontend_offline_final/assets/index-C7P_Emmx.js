(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))a(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function n(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function a(s){if(s.ep)return;s.ep=!0;const o=n(s);fetch(s.href,o)}})();const j=(e,t)=>{try{return localStorage.setItem(e,JSON.stringify(t)),!0}catch(n){return console.error("Error al guardar en localStorage:",n),!1}},q=(e,t=null)=>{try{const n=localStorage.getItem(e);return n?JSON.parse(n):t}catch(n){return console.error("Error al leer de localStorage:",n),t}},H=e=>{try{return localStorage.removeItem(e),!0}catch(t){return console.error("Error al eliminar de localStorage:",t),!1}},W=async e=>{try{const t=await fetch(e);if(!t.ok)throw new Error(`HTTP error! status: ${t.status}`);return await t.json()}catch(t){return console.error(`Error fetching ${e}:`,t),null}},J=e=>typeof e!="string"?"":e.replace(/[<>]/g,"").trim(),K=e=>!(typeof e!="string"||e.trim().length===0||e.length>1e3),Y=(e,t)=>{let n;return function(...s){const o=()=>{clearTimeout(n),e(...s)};clearTimeout(n),n=setTimeout(o,t)}},T=(e,t="info",n=3e3)=>{document.querySelectorAll(".notification").forEach(l=>l.remove());const s=document.createElement("div");s.className=`notification is-${t}`;const o=document.createElement("button");o.className="delete",o.onclick=()=>s.remove();const i=document.createElement("div");i.textContent=e,s.appendChild(o),s.appendChild(i),document.body.appendChild(s),n>0&&setTimeout(()=>{s.parentNode&&s.remove()},n)},G=(e,t="")=>{console.error(`Error en ${t}:`,e),T(`Error: ${e.message}`,"danger")},Q=()=>window.innerWidth<=768,X=()=>Date.now().toString(36)+Math.random().toString(36).substr(2),Z=e=>e?new Date(e).toLocaleDateString("es-ES",{year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit"}):"",ee=e=>e?new Date(e).toLocaleDateString("es-ES",{day:"2-digit",month:"2-digit",year:"numeric"}):"",te=e=>e?e.charAt(0).toUpperCase()+e.slice(1).toLowerCase():"",ne=(e,t=100)=>!e||e.length<=t?e:e.substring(0,t)+"...",ae=e=>/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e),se=e=>{try{return new URL(e),!0}catch{return!1}},ie=async e=>{try{return await navigator.clipboard.writeText(e),T("Copiado al portapapeles","success"),!0}catch(t){return console.error("Error al copiar:",t),!1}},oe=(e,t,n="text/plain")=>{const a=new Blob([e],{type:n}),s=URL.createObjectURL(a),o=document.createElement("a");o.href=s,o.download=t,document.body.appendChild(o),o.click(),document.body.removeChild(o),URL.revokeObjectURL(s)},re=e=>new Promise((t,n)=>{const a=new FileReader;a.onload=s=>t(s.target.result),a.onerror=s=>n(s),a.readAsText(e)}),N=e=>new Promise(t=>setTimeout(t,e)),ce=async(e,t=3,n=1e3)=>{for(let a=0;a<t;a++)try{return await e()}catch(s){if(a===t-1)throw s;await N(n*Math.pow(2,a))}},$=e=>e!==null&&typeof e=="object"&&!Array.isArray(e),le=e=>Array.isArray(e)&&e.length>0,de=(...e)=>e.reduce((t,n)=>$(n)?{...t,...n}:t,{}),ue=(e,t)=>Object.fromEntries(Object.entries(e).filter(([n,a])=>t(n,a))),pe=(e,t,n=void 0)=>t.split(".").reduce((a,s)=>a&&a[s]!==void 0?a[s]:n,e),fe=(e,t,n)=>{const a=t.split("."),s=a.pop(),o=a.reduce((i,l)=>((!i[l]||typeof i[l]!="object")&&(i[l]={}),i[l]),e);return o[s]=n,e},c={saveToLocalStorage:j,getFromLocalStorage:q,removeFromLocalStorage:H,fetchJson:W,sanitizeInput:J,isValidInput:K,debounce:Y,showNotification:T,handleError:G,isMobile:Q,generateId:X,formatDate:Z,formatShortDate:ee,capitalize:te,truncateText:ne,isValidEmail:ae,isValidUrl:se,copyToClipboard:ie,downloadFile:oe,readFile:re,sleep:N,retry:ce,isValidObject:$,isValidArray:le,mergeObjects:de,filterObject:ue,getNestedValue:pe,setNestedValue:fe},F={balances:"Saldos",sales:"Ventas",inventory:"Inventario",customers:"Clientes",reports:"Reportes",test:"Test",settings:"Configuración"},ve=()=>{const e={isInitialized:!1};return{state:e,setState:n=>{Object.assign(e,n)}}},x=e=>F[e]||e,k=e=>{try{const t=`${window.location.pathname}#${e}`;window.history.pushState({sectionId:e},"",t)}catch(t){console.warn("No se pudo actualizar la URL:",t)}},me=()=>window.location.hash.replace("#","")||"balances",ge=e=>Object.keys(F).includes(e),z=()=>{const e=me();if(ge(e)){const t=new CustomEvent("sectionChanged",{detail:{sectionId:e,section:{id:e,title:x(e)}}});document.dispatchEvent(t),window.sidebar&&window.sidebar.setActiveSection&&window.sidebar.setActiveSection(e)}},U=()=>{document.querySelectorAll(".modal").forEach(t=>t.remove())},he=e=>{const{sectionId:t,section:n}=e;try{window.navbar&&window.navbar.updatePageTitle&&window.navbar.updatePageTitle(x(t)),window.sectionContent&&window.sectionContent.loadSection&&window.sectionContent.loadSection(t),k(t)}catch(a){c.handleError(a,`Cambio de sección a ${t}`)}},be=e=>{switch(e.key){case"Escape":U();break;case"F5":e.preventDefault(),c.showNotification("Usa Ctrl+R para recargar","info");break}},ye=()=>{c.isMobile()&&window.sidebar&&window.sidebar.isSidebarCollapsed&&!window.sidebar.isSidebarCollapsed()&&window.sidebar.closeMobileSidebar&&window.sidebar.closeMobileSidebar()},we=e=>{z()},Ee=()=>{window.addEventListener("error",e=>{c.handleError(e.error,"Error global")}),window.addEventListener("unhandledrejection",e=>{c.handleError(new Error(e.reason),"Promesa rechazada")}),document.addEventListener("sectionChanged",e=>{he(e.detail)}),document.addEventListener("keydown",be),window.addEventListener("resize",c.debounce(ye,250)),window.addEventListener("popstate",we)},Se=async()=>{try{if(typeof window.sidebar>"u")throw new Error("Componente Sidebar no está disponible");if(typeof window.navbar>"u")throw new Error("Componente Navbar no está disponible");if(typeof window.sectionContent>"u")throw new Error("Componente SectionContent no está disponible")}catch(e){c.handleError(e,"Inicializar componentes")}},Ce=async()=>{},Te=()=>{try{z()}catch(e){c.handleError(e,"Inicializar navegación")}},xe=()=>{try{const e={settings:{sidebarCollapsed:window.sidebar&&window.sidebar.isSidebarCollapsed?window.sidebar.isSidebarCollapsed():!1,currentSection:window.sidebar&&window.sidebar.getCurrentSection?window.sidebar.getCurrentSection():null},exportDate:new Date().toISOString()};return JSON.stringify(e,null,2)}catch(e){return c.handleError(e,"Exportar datos"),null}},Ie=e=>{try{const t=JSON.parse(e);return t.settings&&(t.settings.sidebarCollapsed!==void 0&&c.saveToLocalStorage("sidebarCollapsed",t.settings.sidebarCollapsed),t.settings.currentSection&&c.saveToLocalStorage("currentSection",t.settings.currentSection.id)),c.showNotification("Datos importados exitosamente","success"),!0}catch(t){return c.handleError(t,"Importar datos"),!1}},Be=async()=>{try{localStorage.clear(),window.location.reload()}catch(e){c.handleError(e,"Reiniciar aplicación")}},Le=()=>{const{state:e,setState:t}=ve(),n=async()=>{if(!e.isInitialized)try{await Se(),Ee(),await Ce(),Te(),t({isInitialized:!0}),c.showNotification("¡Bienvenido a TUYA Fast-Data!","success",2e3),console.log("Aplicación TUYA Fast-Data inicializada correctamente")}catch(s){c.handleError(s,"Inicialización de la aplicación")}};return(async()=>{try{document.readyState==="loading"?document.addEventListener("DOMContentLoaded",n):n()}catch(s){c.handleError(s,"Inicialización de la aplicación")}})(),{getState:()=>({...e}),restart:Be,exportAppData:xe,importAppData:Ie,getSectionTitle:x,updateURL:k,closeAllModals:U,getAppInfo:()=>({name:"TUYA Fast-Data",version:"1.0.0",initialized:e.isInitialized,currentSection:window.sidebar&&window.sidebar.getCurrentSection?window.sidebar.getCurrentSection():null,sidebarCollapsed:window.sidebar&&window.sidebar.isSidebarCollapsed?window.sidebar.isSidebarCollapsed():!1}),reinit:n}},Ae=[{id:"balances",title:"Saldos",icon:"fas fa-chart-pie",route:"/balances"},{id:"sales",title:"Ventas",icon:"fas fa-chart-line",route:"/sales"},{id:"inventory",title:"Inventario",icon:"fas fa-boxes",route:"/inventory"},{id:"customers",title:"Clientes",icon:"fas fa-users",route:"/customers"},{id:"reports",title:"Reportes",icon:"fas fa-file-alt",route:"/reports"},{id:"test",title:"Test",icon:"fas fa-flask",route:"/test"},{id:"settings",title:"Configuración",icon:"fas fa-cog",route:"/settings"}],Ne=()=>{const e={isCollapsed:c.getFromLocalStorage("sidebarCollapsed",!1),currentSection:c.getFromLocalStorage("currentSection","balances"),sections:Ae};return{state:e,setState:a=>{Object.assign(e,a)},saveState:()=>{c.saveToLocalStorage("sidebarCollapsed",e.isCollapsed),c.saveToLocalStorage("currentSection",e.currentSection)}}},$e=e=>{const t=document.getElementById("sidebarNav");if(!t)return;const n=e.map(a=>`
    ...
    `).join("");t.innerHTML=n},B=e=>{const t=document.getElementById("sidebar"),n=document.getElementById("mainContent");t&&t.classList.toggle("collapsed",e),n&&n.classList.toggle("sidebar-collapsed",e);const a=document.getElementById("sidebarLogo"),s=document.getElementById("sidebarTitle");a&&(a.style.display=e?"none":"block"),s&&(s.style.display=e?"none":"block")},w=e=>{document.querySelectorAll(".nav-item").forEach(a=>a.classList.remove("active"));const n=document.querySelector(`[data-section="${e}"]`);n&&n.classList.add("active")},E=(e,t)=>t.find(n=>n.id===e),S=()=>{if(c.isMobile()){const e=document.getElementById("sidebar");e&&e.classList.remove("mobile-open")}},Fe=()=>{if(c.isMobile()){const e=document.getElementById("sidebar");e&&e.classList.add("mobile-open")}};function ke(e){const{state:t,setState:n,saveState:a}=Ne();e&&(e.className="sidebar",e.innerHTML=`
        ...
        `);const s=()=>{const r=!t.isCollapsed;n({isCollapsed:r}),B(r),a()},o=r=>{n({currentSection:r}),w(r),a();const f=new CustomEvent("sectionChanged",{detail:{sectionId:r,section:E(r,t.sections)}});document.dispatchEvent(f)},i=r=>{if(t.sections.find(f=>f.id===r)){n({currentSection:r}),w(r),a();const f=new CustomEvent("sectionChanged",{detail:{sectionId:r,section:E(r,t.sections)}});document.dispatchEvent(f)}},l=()=>{const r=document.getElementById("sidebarToggle");r&&r.addEventListener("click",s),document.querySelectorAll(".nav-item").forEach(u=>{u.addEventListener("click",d=>{d.preventDefault();const v=u.dataset.section;o(v)})}),document.addEventListener("keydown",u=>{u.ctrlKey&&u.key==="b"&&(u.preventDefault(),s())}),document.addEventListener("click",u=>{if(c.isMobile()&&t.isCollapsed===!1){const d=document.getElementById("sidebar"),v=d&&d.contains(u.target),g=u.target.closest("#sidebarToggle");!v&&!g&&S()}}),window.addEventListener("resize",()=>{window.innerWidth>768&&S()}),window.addEventListener("popstate",()=>{const u=window.location.hash.replace("#",""),d=u&&t.sections.find(v=>v.id===u)?u:"balances";i(d)})},p=()=>{$e(t.sections),l();const r=window.location.hash.replace("#",""),f=r&&t.sections.find(u=>u.id===r)?r:t.currentSection;n({currentSection:f}),w(f),B(t.isCollapsed),a()};return setTimeout(p,10),{getState:()=>({...t}),toggleSidebar:s,navigateToSection:o,setActiveSection:i,getCurrentSection:()=>E(t.currentSection,t.sections),getAllSections:()=>[...t.sections],isSidebarCollapsed:()=>t.isCollapsed,closeMobileSidebar:S,openMobileSidebar:Fe,reinit:p}}const ze={balances:"Saldos",sales:"Ventas",inventory:"Inventario",customers:"Clientes",reports:"Reportes",test:"Test",settings:"Configuración"},D=e=>ze[e]||e,Ue=e=>{const t=document.getElementById("pageTitle");t&&(t.textContent=e)},R=()=>{const e=document.getElementById("globalSearch");e&&(e.value="")},C=async e=>{if(!e||e.length<2){c.showNotification("Búsqueda global no disponible","info");return}try{c.showNotification(`Búsqueda global: "${e}" - Funcionalidad no implementada`,"info")}catch(t){c.handleError(t,"Búsqueda global")}},De=e=>{try{const t=new CustomEvent("sectionChanged",{detail:{sectionId:e,section:{id:e,title:D(e)}}});document.dispatchEvent(t),R()}catch(t){c.handleError(t,"Navegar a sección")}},Re=()=>{const e=document.getElementById("globalSearch"),t=document.getElementById("globalSearchBtn");e&&e.addEventListener("keypress",n=>{if(n.key==="Enter"){const a=n.target.value.trim();a&&C(a)}}),t&&t.addEventListener("click",()=>{const n=e?e.value.trim():"";n&&C(n)})};function Ve(e){if(!e)return;e.innerHTML=`
    ...
    `;const t=()=>{Re()};return t(),{performGlobalSearch:C,navigateToSection:De,updatePageTitle:Ue,getSectionTitle:D,clearGlobalSearch:R,showLoading:()=>{},hideLoading:()=>{},reinit:t}}const Oe="modulepreload",Me=function(e){return"/"+e},L={},Pe=function(t,n,a){let s=Promise.resolve();if(n&&n.length>0){let p=function(r){return Promise.all(r.map(f=>Promise.resolve(f).then(u=>({status:"fulfilled",value:u}),u=>({status:"rejected",reason:u}))))};document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),l=i?.nonce||i?.getAttribute("nonce");s=p(n.map(r=>{if(r=Me(r),r in L)return;L[r]=!0;const f=r.endsWith(".css"),u=f?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${r}"]${u}`))return;const d=document.createElement("link");if(d.rel=f?"stylesheet":Oe,f||(d.as="script"),d.crossOrigin="",d.href=r,l&&d.setAttribute("nonce",l),document.head.appendChild(d),f)return new Promise((v,g)=>{d.addEventListener("load",v),d.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${r}`)))})}))}function o(i){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=i,window.dispatchEvent(l),!l.defaultPrevented)throw i}return s.then(i=>{for(const l of i||[])l.status==="rejected"&&o(l.reason);return t().catch(o)})};let b=[];const _e=async()=>{try{const t=await(await fetch("/json/balances-data.json")).json();return b=t.balances,t}catch(e){return console.error("Error cargando datos de balances:",e),b=[{id:1,concepto:"Venta de productos",categoria:"Ventas",monto:15e3,fecha:"2024-01-15",tipo:"ingreso",descripcion:"Venta de productos electrónicos"}],{balances:b}}},y=(e,t)=>{const n=e.toLowerCase(),a=t.toLowerCase();if(n===a)return 1;if(n.includes(a)||a.includes(n))return .8;const s=n.split(" "),o=a.split(" "),i=s.filter(r=>o.includes(r));if(i.length>0)return .6+i.length*.1;let l=0;const p=Math.min(n.length,a.length);for(let r=0;r<p;r++)n[r]===a[r]&&l++;return l/Math.max(n.length,a.length)},je=(e,t={})=>{if(!e.trim()&&Object.keys(t).length===0)return b;const n=b.filter(a=>{let s=!1;const o=[a.concepto,a.categoria,a.descripcion,a.cliente,a.proveedor,a.plataforma].filter(Boolean);if(e.trim()){const i=e.toLowerCase();s=o.some(l=>y(l,e)>.3||l.toLowerCase().includes(i))}else s=!0;return t.categoria&&a.categoria!==t.categoria&&(s=!1),t.tipo&&a.tipo!==t.tipo&&(s=!1),t.metodo_pago&&a.metodo_pago!==t.metodo_pago&&(s=!1),s});return e.trim()&&n.sort((a,s)=>{const o=Math.max(y(a.concepto,e),y(a.categoria,e),y(a.descripcion,e));return Math.max(y(s.concepto,e),y(s.categoria,e),y(s.descripcion,e))-o}),n},qe=(e,t)=>{if(t.length>0)return[];const n=[],a=[...new Set(b.map(i=>i.categoria))];n.push(...a.slice(0,3));const o=b.map(i=>i.concepto).join(" ").toLowerCase().split(" ").filter(i=>i.length>3).filter((i,l,p)=>p.indexOf(i)===l).slice(0,5);return n.push(...o),[...new Set(n)].slice(0,6)},V=e=>new Intl.NumberFormat("es-CO",{style:"currency",currency:"COP"}).format(e),O=e=>new Date(e).toLocaleDateString("es-CO",{year:"numeric",month:"long",day:"numeric"}),He=(e,t)=>{if(e.length===0){const n=qe(t,e);return`
...
Fecha: ${O(t.fecha)}`)};const We=()=>`
    ...
    `,Je=()=>{const e=document.getElementById("userDropdown"),t=document.getElementById("userDropdownMsg");if(!e)return;let n=localStorage.getItem("lider_activo")||sessionStorage.getItem("lider_activo");n&&Array.from(e.options).some(a=>a.value===n)?(e.value=n,localStorage.setItem("lider_activo",n),sessionStorage.setItem("lider_activo",n)):(e.value="",n="",localStorage.removeItem("lider_activo"),sessionStorage.removeItem("lider_activo")),e.addEventListener("change",a=>{const s=a.target.value;s?(localStorage.setItem("lider_activo",s),sessionStorage.setItem("lider_activo",s),t&&(t.textContent=`Líder activo: ${s}`,t.style.color="#d32f2f")):(localStorage.removeItem("lider_activo"),sessionStorage.removeItem("lider_activo"),t&&(t.textContent="Selecciona un usuario",t.style.color="#111")),t&&(t.style.opacity=1,setTimeout(()=>{t.style.opacity=.5},2e3))}),t&&(e.value?(t.textContent=`Líder activo: ${e.value}`,t.style.color="#d32f2f"):(t.textContent="Selecciona un usuario",t.style.color="#111"),t.style.opacity=1)},Ke=async()=>{try{Je();const e=await _e(),t=document.getElementById("categoriaFilter");t&&e.categorias&&e.categorias.forEach(m=>{const h=document.createElement("option");h.value=m,h.textContent=m,t.appendChild(h)});const n=document.getElementById("searchInput"),a=document.getElementById("categoriaFilter"),s=document.getElementById("tipoFilter"),o=document.getElementById("metodoPagoFilter");let i;const l=()=>{const m=n.value,h={categoria:a.value,tipo:s.value,metodo_pago:o.value};M(m,h)};n.addEventListener("input",()=>{clearTimeout(i),i=setTimeout(l,300)}),[a,s,o].forEach(m=>{m.addEventListener("change",l)}),n.addEventListener("keypress",m=>{m.key==="Enter"&&l()});const p=document.getElementById("uploadBtn"),r=document.getElementById("showUploadBtn"),f=document.getElementById("fileUploadContainer"),u=document.getElementById("searchContainer"),d=async()=>{if(f.style.display="block",u.style.display="none",!window.fileUpload){const{FileUpload:m}=await Pe(async()=>{const{FileUpload:h}=await import("./FileUpload-B30Wgq8x.js");return{FileUpload:h}},[]);window.fileUpload=new m("fileUploadContainer")}},v=()=>{f.style.display="none",u.style.display="block",window.fileUpload&&window.fileUpload.reset()};p&&p.addEventListener("click",d),r&&r.addEventListener("click",d);const g=document.createElement("button");g.className="button is-small",g.innerHTML=`
            <span class="icon">
                <i class="fas fa-arrow-left"></i>
            </span>
            <span>Volver a búsqueda</span>
        `,g.addEventListener("click",v),setTimeout(()=>{const m=f.querySelector(".upload-content");m&&m.appendChild(g)},100),console.log("Vista de Balances inicializada con búsqueda, upload y menú de usuario")}catch(e){console.error("Error inicializando vista de Balances:",e)}},Ye={getContent:We,initialize:Ke},Ge=()=>`
        <div class="content-card">
    ...
    `,dt=()=>{const e=document.getElementById("sendTestBtn"),t=document.getElementById("excelFileInput"),n=document.getElementById("fileName");e&&e.addEventListener("click",I),t&&t.addEventListener("change",a=>{const s=a.target.files[0];s?["application/vnd.openxmlformats-officedocument.spreadsheetml.sheet","application/vnd.ms-excel","text/csv","application/csv"].includes(s.type)||s.name.endsWith(".xlsx")||s.name.endsWith(".xls")||s.name.endsWith(".csv")?(n.textContent=s.name,e.disabled=!1,c.showNotification(`Archivo seleccionado: ${s.name}`,"success")):(n.textContent="Ningún archivo seleccionado",e.disabled=!0,c.showNotification("Por favor, selecciona un archivo Excel válido (.xlsx, .xls, .csv)","warning"),t.value=""):(n.textContent="Ningún archivo seleccionado",e.disabled=!0)})},I=async()=>{const e=document.getElementById("excelFileInput"),t=document.getElementById("sendTestBtn"),n=document.getElementById("testResponseArea"),a=document.getElementById("testErrorArea"),s=document.getElementById("testResponseContent"),o=document.getElementById("testErrorContent");if(!e||!t){console.error("Elementos del DOM no encontrados"),c.showNotification("Error: No se pudieron encontrar los elementos necesarios","danger");return}if(!n||!a||!s||!o){console.error("Elementos de respuesta no encontrados"),c.showNotification("Error: No se pudieron encontrar los elementos de respuesta","danger");return}const i=e.files[0];if(!i){c.showNotification("Por favor, selecciona un archivo Excel","warning");return}try{t.classList.add("is-loading"),t.disabled=!0,n&&(n.style.display="none"),a&&(a.style.display="none");const l=new FormData;l.append("file",i),l.append("view_name","balance");const p=await fetch("http://localhost:8000/api/v1/df/upload_file/mateo",{method:"POST",body:l});console.log("FormData creado:");for(let[d,v]of l.entries())console.log(`${d}:`,v);const r="http://localhost:8000/api/v1/balance/upload",f={method:"POST",body:l};if(console.log("Enviando archivo a:",r),console.log("Archivo:",i.name,"Tamaño:",i.size,"Tipo:",i.type),console.log("Configuración de petición:",f),console.log("Respuesta del servidor:",p.status,p.statusText),!p.ok){let d={};try{d=await p.json()}catch{d={error:await p.text()}}throw new Error(`HTTP ${p.status}: ${d.error||p.statusText}`)}const u=await p.json();if(s){s.innerHTML=`
            ...
            `,n&&(n.style.display="block");const d=document.getElementById("refreshPageBtn"),v=document.getElementById("uploadAnotherBtn");d&&d.addEventListener("click",()=>{window.location.reload()}),v&&v.addEventListener("click",()=>{const g=document.getElementById("excelFileInput"),m=document.getElementById("fileName"),h=document.getElementById("sendTestBtn");g&&(g.value=""),m&&(m.textContent="Ningún archivo seleccionado"),h&&(h.disabled=!0),n&&(n.style.display="none"),a&&(a.style.display="none"),c.showNotification("Listo para subir otro archivo","info")})}c.showNotification("Archivo Excel enviado exitosamente al backend","success")}catch(l){console.error("Error enviando archivo al backend:",l);const p=ct(l);try{o.innerHTML=`
            ...
            `,a.style.display="block";const r=document.getElementById("retryUploadBtn"),f=document.getElementById("clearErrorBtn");r&&r.addEventListener("click",()=>{a.style.display="none",I()}),f&&f.addEventListener("click",()=>{const u=document.getElementById("excelFileInput"),d=document.getElementById("fileName"),v=document.getElementById("sendTestBtn");u&&(u.value=""),d&&(d.textContent="Ningún archivo seleccionado"),v&&(v.disabled=!0),a.style.display="none",n&&(n.style.display="none"),c.showNotification("Formulario limpiado","info")})}catch(r){console.error("Error mostrando el error:",r),c.showNotification(p.message,"danger")}c.showNotification(p.message,"danger")}finally{t&&(t.classList.remove("is-loading"),t.disabled=!1)}},ut=()=>{dt(),console.log("Vista de Test inicializada")},pt={getContent:lt,initialize:ut,sendExcelToBackend:I},ft=()=>`
        <div class="content-card">
            <div class="card-header">
